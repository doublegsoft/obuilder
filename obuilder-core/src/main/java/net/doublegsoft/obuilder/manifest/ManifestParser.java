...
import net.doublegsoft.obuilder.manifest.BundleCapability;
import net.doublegsoft.obuilder.manifest.BundleInfo;
import net.doublegsoft.obuilder.manifest.BundleRequirement;
import net.doublegsoft.obuilder.manifest.ExportPackage;
import net.doublegsoft.obuilder.manifest.ManifestHeaderElement;
import net.doublegsoft.obuilder.manifest.ManifestHeaderValue;
import net.doublegsoft.obuilder.manifest.Version;
